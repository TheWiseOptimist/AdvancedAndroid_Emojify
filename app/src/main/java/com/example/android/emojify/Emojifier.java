...
class Emojifier {
    ...
    static Bitmap detectFacesAndOverlayEmoji(Context context, Bitmap picture) {
        ...
        // TODO completed (3): Change the name of the detectFaces() method to detectFacesAndOverlayEmoji() and the return type from void to Bitmap
...
//                whichEmoji(face);
                ...
                // TODO completed (4): Create a variable called emojiBitmap to hold the appropriate
                // Emoji bitmap and remove the call to whichEmoji()
                Bitmap emojiBitmap;
                // TODO completed (5): Create a switch statement on the result of the whichEmoji() call,
                ...
                // TODO completed (8): Call addBitmapToFace(), passing in the resultBitmap,
                // the emojiBitmap and the Face  object, and assigning the result to resultBitmap
