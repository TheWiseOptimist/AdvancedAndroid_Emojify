    ...
    static void detectFaces(Context context, Bitmap picture) {
        ...
        if(faces.size() == 0) {
            ...
            for (int i = 0; i < faces.size(); ++i) {
                ...
                // TODO (4): Create a variable called emojiBitmap to hold the appropriate
                // Emoji bitmap and remove the call to whichEmoji()
                // TODO (5): Create a switch statement on the result of the whichEmoji() call,
                // and assign the proper emoji bitmap to the variable you created
                // TODO (8): Call addBitmapToFace(), passing in the resultBitmap,
